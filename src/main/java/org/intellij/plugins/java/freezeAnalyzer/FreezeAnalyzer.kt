package org.intellij.plugins.java.freezeAnalyzer
...
object FreezeAnalyzer {
  ...
  private fun isWriteLockWait(threadState: ThreadState): Boolean =
    threadState.stackTrace.lineSequence().map { it.trimStart() }.any { it.startsWith("at com.intellij.openapi.application.impl.ReadMostlyRWLock.writeLock") ||
